  ...
  <div>
    <lay-row space="10">
      ...
      <lay-col>
        ...
        <lay-col md="11">
          <lay-input placeholder="请输入宠物名" v-model="petInfo.petName">
            <template #prepend>宠物名</template>
          </lay-input>
        </lay-col>
        <lay-col md="11">
          <lay-input placeholder="请输入宠物品种" v-model="petInfo.variety">
    ...
    <lay-row space="10">
      <lay-col md="11">
        <lay-input placeholder="请输入性别" v-model="petInfo.petSex">
          <template #prepend>性别</template>
        </lay-input>
      </lay-col>
      <lay-col md="11">
        <lay-input placeholder="请输入领养状态" v-model="petInfo.petStatus">
