...
<div>
    ...
    <div class="div1">
        <div v-for="todo in todos" class="div2">
            1
        </div>
    </div>
    <div id="app">
        <ul v-for="(item,index) in mockData">
            <li class="item">
...
const mockData = ref([{
    "id": 1,
    "img": "https://img13.360buyimg.com/n7/jfs/t1/204395/30/8748/221924/6153df6bE11359c8c/f0a78ca2e00b7116.jpg",
...
const todos = ref([1,2,3,3,1,2,3,3,1,2,3,3])
